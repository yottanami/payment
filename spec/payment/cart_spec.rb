...
describe 'Cart' do
  ...
  it 'adds a promotion to cart' do
    @cart.add_promotion @promotion1
    expect(@cart.promotions).to include(@promotion1)
  end

  it 'removes a promotion from cart' do
    @cart.remove_promotion @promotion1
    expect(@cart.promotions).not_to include(@promotion1)
  end
  ...
  it 'calculates total price after 10percent discount' do
    @cart.add @product1
    @cart.add @product2
    @cart.add @product3
